 ...
 *
 */
public class WriteToFileStaticMethod extends StaticMethod {

	public WriteToFileStaticMethod(String name, Bytecode bc, Stack s, Environment env) {
		super(name, bc, s, env);
	}
	...
	public void perform() throws EmptyStackPopException, StackOverflowException, ProgramExecutionException {
		...
		try {
			FileUtil.writeTextToFile(Util.toString(o, " "), f, false);

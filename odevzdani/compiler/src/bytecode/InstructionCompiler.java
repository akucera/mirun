...
public class InstructionCompiler {
	...
	private MethodTab staticMethodsTab;
	 ...
	 */
	public InstructionCompiler(String instrString, MethodTab staticMethodsTab) {
		...
		this.staticMethodsTab = staticMethodsTab;
		//initMethodsTable();
	}
	...
	*/
	...
	private IInstruction instructionFromLine(String line) {
		...
		if (line.startsWith(IInstruction.CALL_INSTR_NAME)) {
			return new CallInstruction(line, staticMethodsTab);
		}

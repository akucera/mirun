...
\end{itemize}
%-----------------------------------------------------------------------------------------------------
\section{Spuštìní algoritmu pomocí jazyka}
...
\subsection{Compiler}
%-----------------------------------------------------------------------------------------------------
\subsection{Vlastní algoritmy}

Pro otestování funkènosti jazyka jsme zvolili následující algoritmy:
...
Ze zadání jsme pak zvolili implementaci problému batohu (Backpack - Knapsack problem).
